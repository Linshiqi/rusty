...
///
/// Named here, in the one module both sides compile: the updater's
/// endpoint in `tauri.conf.json` is checked against these by a test in
/// rusty-app, and the Help menu is wasm. Written out in full rather than
