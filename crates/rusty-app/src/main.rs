...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::disk_sweep,
            commands::disk_remove,
            commands::disk_remove_cache,
            commands::disk_auto_sweep,
            ...
            commands::set_vim,
            commands::auto_save_enabled,
            commands::set_auto_save,
            commands::editor_view,
            commands::set_editor_view,
            commands::rust_analyzer_path,
            commands::set_rust_analyzer_path,
            commands::display_locale,
            commands::set_display_locale,
            files::file_tree,
            files::unlinked_files,
            files::open_file,
            files::read_blob,
            files::save_file,
            files::create_entry,
            ...
            lsp::lsp_close,
            lsp::lsp_complete,
            lsp::lsp_resolve_completion,
            lsp::lsp_hover,
            lsp::lsp_definition,
            lsp::lsp_references,
            lsp::lsp_implementations,
            ...
            lsp::lsp_calls,
            lsp::lsp_expand_macro,
            lsp::lsp_inlay_hints,
            lsp::lsp_signature,
            lsp::lsp_semantic,
            lsp::lsp_code_actions,
            lsp::lsp_apply_action,
            lsp::lsp_rename,
...
mod wire_names {
    ...
    fn every_constant_names_a_real_handler() {
        ...
        assert_named! {
            ...
            cmd::workbench::AUTO_SAVE => commands::auto_save_enabled,
            cmd::workbench::SET_AUTO_SAVE => commands::set_auto_save,
            cmd::workbench::EDITOR_VIEW => commands::editor_view,
            cmd::workbench::SET_EDITOR_VIEW => commands::set_editor_view,
            cmd::workbench::RUST_ANALYZER => commands::rust_analyzer_path,
            cmd::workbench::SET_RUST_ANALYZER => commands::set_rust_analyzer_path,
            ...
            cmd::disk::REPORT => commands::disk_report,
            cmd::disk::SWEEP => commands::disk_sweep,
            cmd::disk::REMOVE => commands::disk_remove,
            cmd::disk::REMOVE_CACHE => commands::disk_remove_cache,
            cmd::disk::AUTO_SWEEP => commands::disk_auto_sweep,
            ...
            cmd::files::UNLINKED => files::unlinked_files,
            cmd::files::OPEN => files::open_file,
            cmd::files::BLOB => files::read_blob,
            cmd::files::SAVE => files::save_file,
            cmd::files::CREATE => files::create_entry,
            cmd::files::MOVE => files::move_entry,
            cmd::files::COPY => files::copy_entry,
            cmd::files::RENAME => files::rename_entry,
            cmd::files::DELETE => files::delete_entry,
            cmd::files::REVEAL => files::reveal_entry,
            cmd::files::DETACH => files::open_editor_window,
            cmd::files::REATTACH => files::reattach_editor_window,
            cmd::files::REPAINT => files::repaint_text,
            cmd::files::HIGHLIGHT_SNIPPET => files::highlight_snippet,
            ...
            cmd::lsp::CLOSE => lsp::lsp_close,
            cmd::lsp::COMPLETE => lsp::lsp_complete,
            cmd::lsp::RESOLVE_COMPLETION => lsp::lsp_resolve_completion,
            cmd::lsp::HOVER => lsp::lsp_hover,
            cmd::lsp::DEFINITION => lsp::lsp_definition,
            cmd::lsp::REFERENCES => lsp::lsp_references,
            cmd::lsp::IMPLEMENTATIONS => lsp::lsp_implementations,
            cmd::lsp::TYPE_DEFINITION => lsp::lsp_type_definition,
            cmd::lsp::HIGHLIGHTS => lsp::lsp_highlights,
            cmd::lsp::DOCUMENT_SYMBOLS => lsp::lsp_document_symbols,
            cmd::lsp::WORKSPACE_SYMBOLS => lsp::lsp_workspace_symbols,
            cmd::lsp::CALL_HIERARCHY => lsp::lsp_call_hierarchy,
            cmd::lsp::CALLS => lsp::lsp_calls,
            cmd::lsp::EXPAND_MACRO => lsp::lsp_expand_macro,
            cmd::lsp::INLAY_HINTS => lsp::lsp_inlay_hints,
            cmd::lsp::SIGNATURE => lsp::lsp_signature,
            cmd::lsp::SEMANTIC => lsp::lsp_semantic,
            cmd::lsp::ACTIONS => lsp::lsp_code_actions,
            cmd::lsp::APPLY_ACTION => lsp::lsp_apply_action,
            ...
            cmd::sim::SENSOR_SET => simulate::sim_sensor_set,
            cmd::sim::SIGNAL_SET => simulate::sim_signal_set,
            cmd::sim::SWITCH => simulate::sim_switch,
            ...
            cmd::sim::IMPORT_WOKWI => simulate::sim_import_wokwi,
            ...
            cmd::debug::TEST => debug::debug_test,
            ...
            cmd::git::REFS => git::git_refs,
            cmd::git::STAMP => git::git_stamp,
            cmd::git::STATUS => git::git_status,
            cmd::git::IDENTITY => git::git_identity,
            cmd::git::STASHES => git::git_stashes,
            cmd::git::REMOTES => git::git_remotes,
            cmd::git::INCLUDE_NESTED => git::git_include_nested,
            cmd::git::DIFF => git::git_diff,
            cmd::git::STAGE => git::git_stage,
            cmd::git::BLOB => git::git_blob,
            cmd::git::CLONE => git::git_clone,
            cmd::git::WINDOW => git::open_git_window,
